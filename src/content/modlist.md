...
**If you ARE using Distant Horizons AND shaders:**

⚠️ I highly reccomend allocating at least 8-12 GiB of RAM as well if you use the below arguments.

```
-XX:+UnlockExperimentalVMOptions -XX:+UnlockDiagnosticVMOptions -XX:+AlwaysActAsServerClassMachine -XX:+AlwaysPreTouch -XX:+DisableExplicitGC -XX:+UseNUMA -XX:NmethodSweepActivity=1 -XX:ReservedCodeCacheSize=400M -XX:NonNMethodCodeHeapSize=12M -XX:ProfiledCodeHeapSize=194M -XX:NonProfiledCodeHeapSize=194M -XX:-DontCompileHugeMethods -XX:MaxNodeLimit=240000 -XX:NodeLimitFudgeFactor=8000 -XX:+UseVectorCmov -XX:+PerfDisableSharedMem -XX:+UseFastUnorderedTimeStamps -XX:+UseCriticalJavaThreadPriority -XX:ThreadPriorityPolicy=1 -XX:AllocatePrefetchStyle=3 -XX:+UseZGC -XX:AllocatePrefetchStyle=1 -XX:-ZProactive -XX:+UseZGC -XX:AllocatePrefetchStyle=1 -XX:-ZUncommit -XX:+ZGenerational -Dgraal.VectorizeSIMD=false
```
...
| Library     | [Bookshelf](https://modrinth.com/mod/bookshelf-lib)                                                               |                                                           | Both            |
| Library     | [Cerbons API](https://modrinth.com/mod/cerbons-api)                                                               |                                                           | Both            |
...
| Library     | [Configurable](https://modrinth.com/mod/configurable)                                                             |                                                           | Both            |
| Performance | [Continuity](https://modrinth.com/mod/continuity)                                                                 | Connected texture support                                 | Client          |
| Library     | [CoroUtil](https://modrinth.com/mod/coroutil)                                                                     |                                                           | Both            |
...
| Library     | [DragonLib](https://modrinth.com/mod/dragonlib)                                                                   |                                                           | Both            |
...
| Performance | [Particle Core](https://modrinth.com/mod/particle-core)                                                           | Particle optimizations                                    | Both            |
| Library     | [Placebo](https://modrinth.com/mod/placebo)                                                                       |                                                           | Both            |
| Library     | [PrickleMC](https://modrinth.com/mod/pricklemc)                                                                   |                                                           | Both            |
...
| Library     | [Tesseract API](https://modrinth.com/mod/tesseract-api)                                                           |                                                           | Both            |
...
| Library     | [BaguetteLib](https://modrinth.com/mod/baguettelib)                                                               |                                                           | Both            |
| Library     | [Balm](https://modrinth.com/mod/balm)                                                                             |                                                           | Both            |
...
| Library     | [Cloth Config v15 API](https://modrinth.com/mod/cloth-config)                                                     |                                                           | Both            |
| Performance | [Clumps](https://modrinth.com/mod/clumps)                                                                         | Clumps XP orbs to reduce XP farm lag                      | Both            |
| Library     | [Collective](https://modrinth.com/mod/collective)                                                                 |                                                           | Both            |
...
| QoL         | [FTB Essentials](https://modrinth.com/mod/ftb-essentials)                                                         | Server commands                                           | Both            |
| Library     | [FTB Library](https://modrinth.com/mod/ftb-library-fabric)                                                        |                                                           | Both            |
...
| Library     | [Forgified Fabric API](https://modrinth.com/mod/forgified-fabric-api)                                             |                                                           | Both            |
...
| Library     | [Fzzy Config](https://modrinth.com/mod/fzzy-config)                                                               |                                                           | Both            |
...
| Library     | [Konkrete](https://modrinth.com/mod/konkrete)                                                                     |                                                           | Both            |
...
| Library     | [Moonlight Lib](https://modrinth.com/mod/moonlight)                                                               |                                                           | Both            |
...
| Library     | [Searchables](https://modrinth.com/mod/searchables)                                                               |                                                           | Both            |
...
| Library     | [SuperMartijn642's Config Library](https://modrinth.com/mod/supermartijn642configlib)                             |                                                           | Both            |
...
| Library     | [Titanium](https://modrinth.com/mod/titanium)                                                                     |                                                           | Both            |
...
| Library     | [TxniLib](https://modrinth.com/mod/txnilib)                                                                       |                                                           | Both            |
| Library     | [UltiCreate Compatibility](https://modrinth.com/mod/ulticreate-compatibility)                                     |                                                           | Both            |
...
| Library     | [oωo (owo-lib)](https://modrinth.com/mod/owo-lib)                                                                 |                                                           | Both            |
